...
func DeleteWorkflowTemplateHandler(baseClient argo.ClientInterface) func(context.Context, *mcp.CallToolRequest, DeleteWorkflowTemplateInput) (*mcp.CallToolResult, *DeleteWorkflowTemplateOutput, error) {
